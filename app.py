...
pyautogui.click(706, 858, duration=0.3)
pyautogui.click(950, 925, duration=0.5)
...
pyautogui.click(1444, 250, duration=0.5)

# ACESSAR CONFIGURACOES

pyautogui.click(1249, 197, duration=0.8)
pyautogui.click(606, 609, duration=0.8)
pyautogui.click(816, 337, duration=0.5)

# ENVIAR ARQUIVO QUE ESTA NO COMPUTADOR

pyautogui.click(564, 158, duration=0.7)
pyautogui.hotkey('enter')
